package com.ty.fieldvalidationspringboot;
...
import com.ty.fieldvalidationspringboot.dto.ResponseStructure;
import static com.ty.fieldvalidationspringboot.util.Messages.*;
...
public class FieldValidationExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		...
		ResponseStructure<Map<String,String>> responseStructure = new ResponseStructure<Map<String,String>>();
		responseStructure.setStatus(HttpStatus.BAD_REQUEST.value());
		responseStructure.setMessage(VLIDATION_ERROR);
